...
const mockTasks = ref<Task[]>([
  { id: 1, code: 'XD12345', name: '溫度測試', user: 'User1', machine: 'Machine1', status: TaskStatus.InProgress },
  { id: 2, code: 'XD23456', name: '電性測試', user: 'User2', machine: 'Machine2', status: TaskStatus.Done },
])
...
const mockMachines = ref([
  { id: 1, name: 'Machine1', code: 'M1', status: MachineStatus.Working, currentTask: { id: 1, code: 'XD12345', name: '溫度測試' } },
